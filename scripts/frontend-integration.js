 ...
 * This file demonstrates how to integrate Mentostable with a web frontend
 */

// For React/Vue/Angular applications
export class MentostableClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MentostableClient(provider, contractAddress);
