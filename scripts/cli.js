...
const contractABI = require("../artifacts/contracts/Mentostable.sol/Mentostable.json").abi;

program
    .name("mentostable-cli")
    .description("CLI tool for Mentostable smart contract")
    .version("1.0.0");
